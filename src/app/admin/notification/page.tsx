...
export default function PushNotification() {
  ...
  const [token, setToken] = useState<string>('cThXZrzGRWGZLFZIXYft6o:APA91bELQ9BhDxs3zb65pVVDIMYaakoggRh9i-pJU__QK6Vi4wGzzc8EA-Ubn4xovQz6wtzy5XjvXJeH07XmKdFY6toYbtOYW3t_CFopXESc5FQtLAhEBDw');
  ...
  const handleSubmitClicked = async () => {
    ...
    if (dataOk) {
      try {
        await createPushNotification(token, title, message, action, arbitraryData, session);
        toast.success('Direct push notification successful');
      } catch (error: any) {
