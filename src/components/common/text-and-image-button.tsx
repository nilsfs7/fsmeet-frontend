...
const buttonSurfaceClass = cn(
  'flex w-44 min-w-0 flex-col items-center gap-2 rounded-xl border border-border/60 bg-secondary-light/85 p-2.5 text-center shadow-xs backdrop-blur-xs',
  ...
  'hover:border-primary/60 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
);
